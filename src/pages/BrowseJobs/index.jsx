        ...
        <div>
            {loading ? (
                ...
                <>
                    ...
                    <div className={styles.searchCountResult}>
                        <b>You have {filteredJobs.length} jobs to apply ^_^</b>
                    </div>
                            ...
                            <div className={styles.filterSectionContent}>
                                <div className={`${styles.filtersectionOne} ${styles.borderBottom}`}>
                                    ...
                                    <select name="text" id="locationFiltration" value={selectedLocation} onChange={handleLocationChange}>
                                        ...
                                        {[
                                            "Alexandria", "Al Khankah", "Arish", "Aswan", "Assiut",
                                            "Badr", "Banha", "Beni Suef", "Cairo", "Damietta",
                                            "el-Arab", "El-Mahalla El-Kubra", "Faiyum", "Giza",
                                            "Helwan", "Hurghada", "Kafr El Sheikh", "Luxor",
                                            "Marsa Matruh", "Minya", "New Cairo", "Obour",
                                            "Qalyub", "Qena", "Quesna", "Sadat City",
                                            "Sharm El Sheikh", "Shibin El Kom", "Sohag",
                                            "6th of October City"
                                        ].map(location => (
