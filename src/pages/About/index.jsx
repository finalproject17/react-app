  ...
  return (
    ...
    <Container>
      <section className={`${styles.descriptionSection} container`}>
       ...
       <div className={styles.caresrs1}>  <span>Careers</span> is a prominent Egyptian job search and recruitment platform designed to connect job seekers with employers across various industries in Egypt. </div>   
